...
static IdSetSet **get_descendants1(int wdim, IdSetSet ** w, int nsamples,
    ...
    *newdim = n;
    ...
    IdSetSet **d = NULL;
    // This allocation syntax avoids warnings generated by
    // the -Walloc-size-larger-than=PTRDIFF_MAX option, which
    // is used automatically by gcc under Linux.
    {
        unsigned un = (unsigned) n;
        d = malloc( un * sizeof(IdSetSet *) );
        CHECKMEM(d);
    }
